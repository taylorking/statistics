...
C: 
H0: Same Sex marriage law is the same across states. 
HA: Same Sex marriage law is not the same across states.

H0: Marijuana legality and region are independent factors.
HA: Marijuana legality and region are not independent factors..
```{r}
# D.
